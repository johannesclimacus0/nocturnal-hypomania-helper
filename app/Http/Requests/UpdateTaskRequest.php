...
final class UpdateTaskRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'estimated_time_minutes' => 'bail|sometimes|required|integer|min:1|max:65535',
            'status' => ['bail', 'sometimes', 'required', Rule::enum(TaskStatus::class)],
            'difficulty' => ['bail', 'sometimes', 'required', Rule::enum(TaskDifficulty::class)],
            'task_type_uuid' => ['bail', 'sometimes', 'required', 'uuid',
    ...
    public function messages(): array
    {
        return [
            ...
            'status.enum' => 'Выберите допустимый статус задачи',
            ...
            'estimated_time_minutes.max' => 'Продолжительность задачи не должна превышать 65535 минут',
            ...
            'task_type_uuid.uuid' => 'Идентификатор типа задачи имеет неверный формат',
            'task_type_uuid.exists' => 'Выбранный тип задачи недоступен',
            'area_uuid.uuid' => 'Идентификатор области имеет неверный формат',
            'area_uuid.exists' => 'Выбранная область недоступна',
            'category_uuid.uuid' => 'Идентификатор категории имеет неверный формат',
